...
public class EndpointVolume
{
    ...
    public EndpointVolume()
    {
        ...
        int retVal = iMde.GetDefaultAudioEndpoint(EDataFlow.eCapture, ERole.eConsole, ref pDevice);
        if (retVal != 0)
        {
        ...
        retVal = iMde.EnumAudioEndpoints(EDataFlow.eCapture, dwStateMask, ref pCollection);
        if (retVal != 0)
        {
        ...
        iAudioEndpoint.GetChannelCount(ref pnChannelCount);
        float level = 0f;
        uint i = 0;
        iAudioEndpoint.GetMasterVolumeLevelScalar(ref level);
        iAudioEndpoint.GetChannelVolumeLevelScalar(0,ref level);
        iAudioEndpoint.QueryHardwareSupport(ref i);
    }
        /*
